...
const retainersBase: RetainerBase[] = [
  { icon: <Clock className="w-5 h-5 text-[#FF4B26]" />, name: 'CADENCE MANAGER', eurPrice: 300, unit: '/mois', description: 'Relances avant deadline, vérif qualité updates' },
  { icon: <UserCheck className="w-5 h-5 text-[#FF4B26]" />, name: 'LEAD NURTURING', eurPrice: 250, unit: '/mois', description: 'Relances leads B/C, templates WhatsApp, SLA 48h' },
  { icon: <Megaphone className="w-5 h-5 text-[#FF4B26]" />, name: 'ADS MANAGEMENT', eurPrice: 500, unit: '/mois', description: 'Gestion campagnes Meta/Google (budget séparé)' },
  { icon: <UserCog className="w-5 h-5 text-[#FF4B26]" />, name: 'ACCOUNT MANAGER DÉDIÉ', eurPrice: 400, unit: '/mois', description: 'Interlocuteur unique, pilotage + recommandations' },
  { icon: <FileBarChart className="w-5 h-5 text-[#FF4B26]" />, name: 'PACK REPORTING EXÉCUTIF', eurPrice: 200, unit: '/mois', description: 'Rapport PDF mensuel complet envoyé à la direction' },
];
